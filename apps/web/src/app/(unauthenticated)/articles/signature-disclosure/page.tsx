  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          By opting to use an electronic signature on our platform, you are agreeing to the terms
          and conditions outlined below.
        </p>

        <h2>Electronic signature requirements</h2>
        <p>
          When you use our platform and the document signing feature you must ensure: <br />
          <ul className="list-[circle]">
            <li>
              {' '}
              Your identity could be shown by a typed name, a personal mark, a personal email, or
              use of an online ID verification method; and{' '}
            </li>
            <li>
              Your intention to sign the document can be shown by a clear agreement, signing on the
              dotted line, or something extra in the context of a response.
            </li>
          </ul>
        </p>
        ...
        <p>
          You hereby consent to use electronic means to sign documents and receive notifications.
        </p>
        <p>
          You must ensure you have access to the following when using the document signing feature
          on our platform:
        </p>
        <ul className="list-[circle]">
        ...
        <p>
          By using the document signature feature, you are consenting to conduct transactions and
          ...
          signing.
          <br /> You have the right to withdraw your consent or not sign the document. To withdraw
          your consent, please contact the sender of the document.
        </p>
        <p>
          You have the right to withdraw your consent or not sign the document. To withdraw your
          consent, please contact the sender of the document.
        </p>
        ...
        <p>
          By proceeding to use the electronic signature service you confirm that you have read and
          understood this Signature Disclosure. You agree to all terms and conditions related to the
          use of electronic signatures and electronic transactions as outlined herein.
        </p>
        <p>
          For any questions regarding this Signature Disclosure or Business Kitz platform, you may
          contact us by emailing{' '}
          <a href="mailto:support@businesskitz.com.au">support@businesskitz.com.au</a> or{' '}
          <a href="mailto:support@businesskitz.com">support@businesskitz.com</a>.
        </p>
      </article>
